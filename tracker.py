...
def SORT(it: List) -> Dict:
    ...
    for i in sorted_by_frame_number:
        ...
        for entity in entities:
            if entity['emotion'] not in separated_by_class:
                separated_by_class[entity['emotion']] = {}
            
            if separated_by_class[entity['emotion']].get(frame_number) is None:
                separated_by_class[entity['emotion']][frame_number] = []
            separated_by_class[entity['emotion']][frame_number].append(entity)
